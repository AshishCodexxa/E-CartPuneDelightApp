...
import com.punedelights.user.fragment.ProductDetailFragment
import com.punedelights.user.fragment.ProductListFragment
...
import com.punedelights.user.model.ProductList
import com.punedelights.user.model.Variants
...
class FlashSaleAdapter(val activity: Activity, private val productList: ArrayList<ProductList?>) :
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        try {
            ...
            Glide.with(activity).load(if (product.image == "") "-" else product.image)

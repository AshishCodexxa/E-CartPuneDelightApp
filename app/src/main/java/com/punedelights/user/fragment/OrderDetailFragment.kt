...
import com.punedelights.user.adapter.OrderItemsAdapter
import com.punedelights.user.adapter.ProductImagesAdapter
import com.punedelights.user.adapter.SelectedImagesAdapter
import com.punedelights.user.helper.ApiConfig.Companion.addMultipleProductInCart
import com.punedelights.user.helper.ApiConfig.Companion.createJWT
import com.punedelights.user.helper.ApiConfig.Companion.getOrders
...
import com.punedelights.user.model.OrderList
import java.io.File
...
//                                com.google.android.apps.maps
            ...
            for (i in order.status_name.indices) {
                ...
                if (i != order.status_name.size - 1) {
                    ...
                    val params1 = LinearLayout.LayoutParams(
                        ...
                        resources.getDimension(com.intuit.sdp.R.dimen._2sdp)
                            .toInt()
                    )
                    params1.weight = 1.0f
    ...
    private fun createStatusUi(
        ...
        textView.textSize = activity.resources.getDimension(com.intuit.ssp.R.dimen._3ssp)
        textView1.textAlignment = View.TEXT_ALIGNMENT_CENTER
        textView1.textSize = activity.resources.getDimension(com.intuit.ssp.R.dimen._3ssp)

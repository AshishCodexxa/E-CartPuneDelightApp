...
import com.punedelights.user.adapter.AddressAdapter
...
class AddressListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (bundle.getString(Constant.FROM)
            ...
            tvTotalItems.text =  "${Constant.TOTAL_CART_ITEM}" + if (Constant.TOTAL_CART_ITEM == 1) activity.getString(R.string.item) else activity.getString(
                R.string.items
            )

...
import com.punedelights.user.activity.PaymentActivity
import com.punedelights.user.adapter.CheckoutItemListAdapter
...
import com.punedelights.user.model.PromoCode
                ...
                try {
                    ...
                    holderParent.tvApply.setOnClickListener {
                        if (!promoCode.is_validate[0].isError) {
                            ...
                            pCodeDiscount =
                                promoCode.is_validate[0].discount.toDouble()

...
import com.punedelights.user.adapter.SupportChatImageAdapter
import com.punedelights.user.adapter.SupportTicketListAdapter
...
import com.punedelights.user.model.SupportTicket
import com.punedelights.user.model.SupportTicketType
import java.io.File
        ...
        try {
            ...
            if (ticketSubject.isEmpty()) {
                ...
                if (!jsonObject.getBoolean(Constant.ERROR)) {
                    ...
                    supportTicketAdapter.setItem(
                        selectedSupportTicketPosition,
                        supportTicket,
                        from
                    )

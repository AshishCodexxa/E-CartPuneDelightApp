...
import com.punedelights.user.adapter.CategoryAdapter
import com.punedelights.user.adapter.OfferAdapter
import com.punedelights.user.adapter.SectionAdapter
import com.punedelights.user.adapter.SliderAdapter
import com.punedelights.user.helper.ApiConfig.Companion.addMarkers
import com.punedelights.user.helper.ApiConfig.Companion.getOfferImage
...
import com.punedelights.user.model.Category
import com.punedelights.user.model.Section
import com.punedelights.user.model.Slider
import java.util.*
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        layoutViewPager = root.findViewById(R.id.layoutViewPager)
...
//            tabLayout.setupWithViewPager(viewPager);
    ...
    fun sectionProductRequest(jsonArray: JSONArray) {
        ...
        try {
            ...
            val sectionAdapter = SectionAdapter(activity, sectionList)

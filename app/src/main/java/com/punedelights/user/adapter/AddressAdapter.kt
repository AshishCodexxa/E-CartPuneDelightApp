...
import com.punedelights.user.fragment.AddressAddUpdateFragment
import com.punedelights.user.fragment.AddressListFragment
import com.punedelights.user.helper.ApiConfig.Companion.isConnected
import com.punedelights.user.helper.ApiConfig.Companion.removeAddress
...
class AddressAdapter(val activity: Activity, private val addresses: ArrayList<Address?>) :
    ...
    override fun onBindViewHolder(holderParent: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.lytMain.setPadding(
            activity.resources.getDimension(com.intuit.sdp.R.dimen._15sdp).toInt(),
            activity.resources.getDimension(com.intuit.sdp.R.dimen._15sdp)
                .toInt(),
            activity.resources.getDimension(com.intuit.sdp.R.dimen._15sdp).toInt(),
            activity.resources.getDimension(com.intuit.sdp.R.dimen._15sdp)
                .toInt()

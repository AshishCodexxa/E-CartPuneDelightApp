package com.punedelights.user.fragment
...
import com.punedelights.user.activity.MainActivity
import com.punedelights.user.adapter.AdapterStyle1
import com.punedelights.user.adapter.ProductLoadMoreAdapter
import com.punedelights.user.adapter.ReviewAdapter
import com.punedelights.user.adapter.SliderAdapter
import com.punedelights.user.helper.ApiConfig.Companion.addMarkers
import com.punedelights.user.helper.ApiConfig.Companion.addMultipleProductInCart
import com.punedelights.user.helper.ApiConfig.Companion.addOrRemoveFavorite
import com.punedelights.user.helper.ApiConfig.Companion.buildCounterDrawable
import com.punedelights.user.helper.ApiConfig.Companion.calculateDays
import com.punedelights.user.helper.ApiConfig.Companion.getCartItemCount
import com.punedelights.user.helper.ApiConfig.Companion.getDiscount
import com.punedelights.user.helper.ApiConfig.Companion.getSettings
import com.punedelights.user.helper.ApiConfig.Companion.isConnected
import com.punedelights.user.helper.ApiConfig.Companion.requestToVolley
import com.punedelights.user.helper.ApiConfig.Companion.stringFormat
import com.punedelights.user.helper.ApiConfig.Companion.toTitleCase
import com.punedelights.user.helper.Constant
import com.punedelights.user.helper.DatabaseHelper
import com.punedelights.user.helper.Session
import com.punedelights.user.helper.Utils.setFormatTime
import com.punedelights.user.helper.VolleyCallback
import com.punedelights.user.model.*
...
class ProductDetailFragment : Fragment() {
    ...
    private lateinit var webViewShippingDetailTitle: TextView
    ...
    private lateinit var tvFssaiLicNo: TextView
    private lateinit var lytProductRatings: LinearLayout
    private lateinit var lytFssaiLicDetails: LinearLayout
    ...
    override fun onCreateView(
        ...
        tvFssaiLicNo = root.findViewById(R.id.tvFssaiLicNo)
        lytFssaiLicDetails = root.findViewById(R.id.lytFssaiLicDetails)
        ...
        webViewShippingDetailTitle = root.findViewById(R.id.webViewShippingDetailTitle)
    ...
    fun setProductDetails(product: Product) {
        try {
            ...
            if (product.fssai_lic_no != "") {
                tvFssaiLicNo.text = product.fssai_lic_no
                lytFssaiLicDetails.visibility = View.VISIBLE
            } else {
                lytFssaiLicDetails.visibility = View.GONE
            }
            ...
            if (product.description.isNotEmpty()) {
                ...
                webViewDescription.visibility = View.GONE
            }

            if (product.shipping_delivery.isNotEmpty()) {
                ...
                webViewShippingDetailTitle.visibility = View.GONE
                webViewShippingDetail.visibility = View.GONE
            }
